...
#include "staticdfsapreachabilityalgorithm.h"
...
StaticDFSAPReachabilityAlgorithm::StaticDFSAPReachabilityAlgorithm()
...
void StaticDFSAPReachabilityAlgorithm::run()
{

}

bool StaticDFSAPReachabilityAlgorithm::query(Vertex *s, Vertex *t)
{
    if (s == t) {
        return true;
...
std::vector<Arc *> StaticDFSAPReachabilityAlgorithm::queryPath(Vertex *s, Vertex *t)
{
    std::vector<Arc*> path;
